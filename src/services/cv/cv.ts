  ...
  Swal.fire({
    ...
    .then((result: any) => {
      ...
      if (result.dismiss === 'cancel') {
        ...
        anchor.href =
          'https://firebasestorage.googleapis.com/v0/b/gus-portfolio.appspot.com/o/gustavo-ramirez-dev-cv-onlyinfo.pdf?alt=media&token=b356b6d6-8846-4f28-94b3-12d964f3fdd1';
