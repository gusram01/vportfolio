  ...
  Swal.fire({
    ...
    .then((result: any) => {
      ...
      if (result.dismiss === 'cancel') {
        ...
        anchor.href =
          'https://firebasestorage.googleapis.com/v0/b/gus-portfolio.appspot.com/o/gustavo-ramirez-dev-cv-onlyinfo.pdf?alt=media&token=923453dc-bb0f-427c-b743-fdd6f810d858';
